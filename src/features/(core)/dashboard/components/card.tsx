...
const Card = ({ icons, description, mark }: ICard) => {
  return (
    <div className="flex items-cenetr gap-3  px-4 py-10 w-full bg-white  border-t-none border-l-none border-r-none border-b-2 border-b-[#2EB166] rounded-md shadow-md">
